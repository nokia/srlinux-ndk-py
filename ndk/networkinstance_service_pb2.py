...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n!ndk/networkinstance_service.proto\x12\x03ndk\x1a\x14ndk/sdk_common.proto\"$\n\"NetworkInstanceSubscriptionRequest\"\'\n\x12NetworkInstanceKey\x12\x11\n\tinst_name\x18\x01 \x01(\t\"\xf1\x01\n\x13NetworkInstanceData\x12\x13\n\x0bnet_inst_id\x18\x01 \x01(\r\x12\x11\n\tbase_name\x18\x02 \x01(\t\x12+\n\rloopback_addr\x18\x03 \x01(\x0b\x32\x14.ndk.IpAddrPrefLenPb\x12\x12\n\noper_is_up\x18\x04 \x01(\x08\x12\x11\n\trouter_id\x18\x05 \x01(\t\x12\x37\n\tinst_type\x18\x06 \x01(\x0e\x32$.ndk.NetworkInstanceData.NetInstType\"%\n\x0bNetInstType\x12\x0b\n\x07\x44\x45\x46\x41ULT\x10\x00\x12\t\n\x05L3VRF\x10\x01\"\x8d\x01\n\x1bNetworkInstanceNotification\x12 \n\x02op\x18\x01 \x01(\x0e\x32\x14.ndk.SdkMgrOperation\x12$\n\x03key\x18\x02 \x01(\x0b\x32\x17.ndk.NetworkInstanceKey\x12&\n\x04\x64\x61ta\x18\x03 \x01(\x0b\x32\x18.ndk.NetworkInstanceDataB%Z#github.com/nokia/srlinux-ndk-go/ndkb\x06proto3'
  ,
...
_NETWORKINSTANCEDATA_NETINSTTYPE = _descriptor.EnumDescriptor(
  name='NetInstType',
  full_name='ndk.NetworkInstanceData.NetInstType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_NETWORKINSTANCESUBSCRIPTIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='ndk.NetworkInstanceSubscriptionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_NETWORKINSTANCEKEY = _descriptor.Descriptor(
  ...
  full_name='ndk.NetworkInstanceKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='inst_name', full_name='ndk.NetworkInstanceKey.inst_name', index=0,
...
_NETWORKINSTANCEDATA = _descriptor.Descriptor(
  ...
  full_name='ndk.NetworkInstanceData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='net_inst_id', full_name='ndk.NetworkInstanceData.net_inst_id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='base_name', full_name='ndk.NetworkInstanceData.base_name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='loopback_addr', full_name='ndk.NetworkInstanceData.loopback_addr', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='oper_is_up', full_name='ndk.NetworkInstanceData.oper_is_up', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='router_id', full_name='ndk.NetworkInstanceData.router_id', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='inst_type', full_name='ndk.NetworkInstanceData.inst_type', index=5,
...
_NETWORKINSTANCENOTIFICATION = _descriptor.Descriptor(
  ...
  full_name='ndk.NetworkInstanceNotification',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='op', full_name='ndk.NetworkInstanceNotification.op', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='key', full_name='ndk.NetworkInstanceNotification.key', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data', full_name='ndk.NetworkInstanceNotification.data', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
NetworkInstanceSubscriptionRequest = _reflection.GeneratedProtocolMessageType('NetworkInstanceSubscriptionRequest', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:ndk.NetworkInstanceSubscriptionRequest)
  })
...
NetworkInstanceKey = _reflection.GeneratedProtocolMessageType('NetworkInstanceKey', (_message.Message,), {
  ...
  '__module__' : 'ndk.networkinstance_service_pb2'
  # @@protoc_insertion_point(class_scope:ndk.NetworkInstanceKey)
  })
...
NetworkInstanceData = _reflection.GeneratedProtocolMessageType('NetworkInstanceData', (_message.Message,), {
  ...
  '__module__' : 'ndk.networkinstance_service_pb2'
  # @@protoc_insertion_point(class_scope:ndk.NetworkInstanceData)
  })
...
NetworkInstanceNotification = _reflection.GeneratedProtocolMessageType('NetworkInstanceNotification', (_message.Message,), {
  ...
  '__module__' : 'ndk.networkinstance_service_pb2'
  # @@protoc_insertion_point(class_scope:ndk.NetworkInstanceNotification)
  })
